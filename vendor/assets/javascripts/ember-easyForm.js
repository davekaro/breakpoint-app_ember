// Last commit: 9e6feb2 (2013-09-01 18:55:08 -0400)
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.labelField || depth0.labelField),stack1 ? stack1.call(depth0, options) : helperMissing.call(depth0, "labelField", options))));
  hashTypes = {};
  hashContexts = {};
...
function program1(depth0,data) {
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.errorField || depth0.errorField),stack1 ? stack1.call(depth0, options) : helperMissing.call(depth0, "errorField", options))));
  }
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.inputField || depth0.inputField),stack1 ? stack1.call(depth0, options) : helperMissing.call(depth0, "inputField", options))));
  hashTypes = {};
  hashContexts = {};
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.hintField || depth0.hintField),stack1 ? stack1.call(depth0, options) : helperMissing.call(depth0, "hintField", options))));
  return buffer;
